...
export function AutoPiPromptDialog({ admission, open, onClose, invoices }: Props) {
  ...
  const duplicate = useMemo(() => admission ? findOpenPiForStudent(admission.studentName, invoices) : null, [admission, open, invoices]);
